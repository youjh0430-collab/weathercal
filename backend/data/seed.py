...
SEED_DATA = [
    ("한강 피크닉", "outdoor", {"weather": ["맑음"], "temp_range": "comfortable"}, "야외, 소셜, 봄"),
    ...
    ("치맥", "outdoor", {"weather": ["맑음"], "temp_range": "comfortable"}, "음식, 소셜"),
    ("빙수 먹으러 가기", "indoor", {"weather": ["맑음"], "temp_range": "warm"}, "음식, 여름"),
    ("냉면 맛집", "indoor", {"weather": ["맑음"], "temp_range": "warm"}, "음식, 여름"),
    ("계곡 물놀이", "outdoor", {"weather": ["맑음"], "temp_range": "warm"}, "야외, 여름"),
    ("워터파크", "outdoor", {"weather": ["맑음"], "temp_range": "warm"}, "야외, 여름"),
    ("쇼핑몰 대피", "indoor", {"weather": ["맑음"], "temp_range": "hot"}, "쇼핑, 여름"),
    ("영화관", "indoor", {"weather": ["맑음"], "temp_range": "hot"}, "여가, 실내"),
    ("팥빙수 투어", "indoor", {"weather": ["맑음"], "temp_range": "hot"}, "음식, 여름"),
    ("단풍길 산책", "outdoor", {"weather": ["맑음"], "temp_range": "cool"}, "산책, 가을"),
    ("전통시장 구경", "outdoor", {"weather": ["맑음"], "temp_range": "cool"}, "쇼핑, 문화"),
    ("호떡 사먹기", "outdoor", {"weather": ["맑음"], "temp_range": "cool"}, "음식, 가을"),
    ("찜질방", "indoor", {"weather": ["맑음"], "temp_range": "cold"}, "여가, 겨울"),
    ("설렁탕 맛집", "indoor", {"weather": ["맑음"], "temp_range": "cold"}, "음식, 겨울"),
    ("군고구마 사먹기", "outdoor", {"weather": ["맑음"], "temp_range": "cold"}, "음식, 겨울"),
    ("집콕", "indoor", {"weather": ["맑음"], "temp_range": "freezing"}, "집콕, 겨울"),
    ("군밤 까먹기", "indoor", {"weather": ["맑음"], "temp_range": "freezing"}, "음식, 집콕"),
    ("이불 속 넷플릭스", "indoor", {"weather": ["맑음"], "temp_range": "freezing"}, "집콕, 여가"),
    ("야외 카페", "outdoor", {"weather": ["구름많음"], "temp_range": "comfortable"}, "카페, 야외"),
    ...
    ("눈 구경 산책", "outdoor", {"weather": ["눈"], "temp_range": "cold"}, "산책, 겨울, 눈"),
    ("붕어빵 투어", "outdoor", {"weather": ["눈"], "temp_range": "cold"}, "음식, 겨울"),
    ("겨울 카페", "indoor", {"weather": ["눈"], "temp_range": "cold"}, "카페, 겨울"),
    ("수정과 만들기", "indoor", {"weather": ["눈"], "temp_range": "freezing"}, "요리, 전통, 겨울"),
